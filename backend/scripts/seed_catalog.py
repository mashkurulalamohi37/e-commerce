...
BANNERS = [
    ("hero", "Galenia Skin Care", "Sebotic Physiological & Anti-Dandruff Shampoo",
     ...
     "/banners/hero-sebotic-galenia.jpg", "Galenia Skin Care & Sebotic Hair Care", "dark", 1),
    ("hero", "Lipiol Derm Collection", "Lipiol Cleansing Oil & Intensive Facial Cream",
     ...
     "/banners/hero-lipiol-collection.jpg", "Lipiol Derm Collection Banner", "dark", 2),
    ("hero", "Swiss Formula", "Hyaluronic Acid & Face Serums",
     ...
     "/banners/hero-swiss-formula.jpg", "Swiss Formula Serums Banner", "dark", 3),
    ("hero", "Sun Protection", "Protelion 50 UVB + UVA Emulsion",
     ...
     "/banners/hero-protelion-sunscreen.jpg", "Protelion 50 Sun Protection Banner", "dark", 4),
    ("offer", "Save up to 25%", "Lipiol Base & Viso Cream", "Restructuring moisturizing cream for severe skin dryness.",
     "Shop Lipiol", "/product/lipiol-base-moisturizing-cream-500-ml", "/catalog/LIPIOL--Crema-Detergente.png",
    ...
    ("offer", "Purifying Treatment", "Keralise Comedolytic & Gel Scrub", "Double exfoliating mechanism for oily and acne-prone skin.",
     "Shop Keralise", "/product/keralise-gel-scrub-30-ml", "/catalog/KERALISE--Gel-Scrub.png",
    ...
    ("offer", "Antimycotic Active", "Micoxil Active Cleanser", "Daily active hygienic cleanser for face, body and hair.",
     "Shop Micoxil", "/product/micoxil-antimycotic-active-cleanser-250-ml", "/catalog/MICOXIL--Active-Cleanser.png",
    ...
    ("offer", "Soothing Relief", "Lenus Refreshing Body Lotion", "Immediate relief for reactive skin and tendency to itchiness.",
     "Shop Lenus", "/product/lenus-soothing-body-lotion-150-ml", "/catalog/KERALISE--Mousse.png",
     "Lenus Lotion", "dark", 4),
]
